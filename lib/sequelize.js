...
var Sequelize = function(database, username, password, options) {
  ...
  if (this.options.dialect === 'cassandra') {
    this.options.dialect = 'cassandra';
    this.pool = undefined;
  ...
  switch (this.getDialect()){
    ...
    case 'sqlite':
      ...
      break;
    case 'cassandra':
      Dialect = require('./dialects/cassandra');
      break;
    default:
      throw new Error('The dialect ' + this.getDialect() + ' is not supported. Supported dialects: mariadb, mssql, mysql, postgres, sqlite and cassandra.');
  }
